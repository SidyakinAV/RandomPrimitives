 ...
 * todo: description
 */
public abstract class BaseTrace<ValuesType> implements Tracing {
    ...
    protected TraceBuilder<ValuesType> getBuilder(@NonNull final Supplier<ValuesType> randomIntSupplier) {
        final TraceBuilder<ValuesType> builder = new TraceBuilder<>(randomIntSupplier, this.traceHolder);
        return builder;
    }
